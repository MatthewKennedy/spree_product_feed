...
- Add a new property by typing **g:gender** in the property field, this will search for your newly created propery, select the proert when it appears in the list, and then enter the value ```female``` and click **update**.
